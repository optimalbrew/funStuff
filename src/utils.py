...
#modified from a file sourced from EMSripten SDK, test.py 


import json
import os
import shutil # https://docs.python.org/3/library/shutil.html?highlight=shutil#module-shutil
import subprocess # https://docs.python.org/3/library/subprocess.html?highlight=subprocess#module-subprocess
import sys
import tempfile # https://docs.python.org/3/library/tempfile.html?highlight=tempfile#module-tempfile
